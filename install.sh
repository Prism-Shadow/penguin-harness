...
#
# The data dir (~/PenguinHarness) is independent of the install dir: reinstall/upgrade never touch data.
#
...
#    fall back to system Node. The data dir (~/PenguinHarness) is separate and untouched. ---

 ...
 * in `@layer ui-theme` what the hook does, which may be nothing: Primer's `.ui-glass` is a no-op.
 * The layer sits after Tailwind's `utilities`, so a recipe beats the utilities its host also
 * carries.
 *

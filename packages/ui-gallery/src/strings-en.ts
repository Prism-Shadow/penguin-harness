...
export const en: GalleryStrings = {
  ...
  section: {
    ...
    notMeasured: "This composition never mounted, so nothing was measured.",
    unreadRules: (count) => `${count} rules could not be read`,
    unset: "unset",
  ...
  foundations: {
    ...
    iconsUnread: (count) => `${count} drawn inline, not read`,

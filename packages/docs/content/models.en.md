...
| custom | `OPENAI_API_KEY` | Any OpenAI-protocol endpoint; ships one preset, Atria Dawn Preview (Responses API at `api.atria-asi.ai/v1`, 256K window, priced at $0 until the vendor publishes prices) |

...
| GET | /agents/:agentId/hooks | Installed hook packages: name, description, version, hook points |
...
| GET | `/api/plugins/:plugin/skills/:skill` (global) | One library skill's full SKILL.md content, for the plugin detail view's reader (any logged-in user) |

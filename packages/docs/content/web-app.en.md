...
- When human approval is required, tool calls show inline allow/deny buttons in the message stream; changing the approval mode updates all open clients for the current user without affecting other users;

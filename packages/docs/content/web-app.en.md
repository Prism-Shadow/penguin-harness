...
| Tab | Contents |
| --- | --- |
| Overview | Basic info, export / import of Agent State snapshots, and updating the config to the current defaults (overwrites customizations, keeping only name/description) |

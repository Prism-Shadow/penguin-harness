 ...
 *
 * BASE_PATH is injected by the GitHub Pages workflow as "/<repo>/docs/" — the docs
 * build is copied into the landing dist under docs/ so both sites ship as one Pages
 * artifact (see scripts/build-site.mjs at the repo root). Local dev defaults to "/".

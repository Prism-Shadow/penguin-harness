 ...
 * managed tab renders as that tab's own label in English, and an unknown key (a tab a
...
describe("kernelTabLabel", () => {
  it("renders every managed tab as its own settings-page label, in English", () => {

...
export const zh = {
  ...
  activities: {
    wafRoot: "WAF 工作区",
    wafRootHint: "包含 framework、modules 和 media 的目录。留空则自动查找。",
    assemble: "构建 WAF 模块",
    moduleRun: "模块构建",
    moduleReady: "已构建",
    specRun: "规格生成",
    previewModule: "打开 WAF 预览",
    olderModule: "基于较早的草稿构建",
    title: "活动",
    create: "创建活动",
    productCode: "产品代码",
    refNum: "参考编号",
    ...
    cancel: "取消生成",
    candidate: "查看候选 JSON",
    useCandidate: "复制候选内容到编辑器",
    reload: "重新加载草稿",
    loading: "加载中…",
    busy: "处理中…",
    saved: "已保存",
    unsaved: "有未保存的更改",
    discard: "放弃未保存的编辑并加载另一个草稿？",
    remoteChanged: "已保存的草稿发生了变化。你的编辑仍然保留；请重新加载后再应用。",
    saveFirst: "生成前请保存描述，并检查或保存规格编辑。",
    readOnly: "只有项目所有者可以编辑活动。",
    runningHelp: "离开此页后生成仍会继续。打开会话以处理工具审批。",
    collection: "集合",
    refresh: "刷新列表",
    status: {
      running: "运行中",
...
- candidate_round_limit：\`5\``,
  ...
  errors: {
    ...
    byCode: {
      ...
      module_spec_required: "请先保存有效规格，再构建模块。",
      module_spec_invalid: "模块场景需要唯一的安全标识符，且不能使用 activity。",
      waf_checkout_missing: "未找到 WAF 工作区。请选择包含 framework、modules 和 media 的目录。",

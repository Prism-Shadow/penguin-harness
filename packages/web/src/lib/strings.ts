...
export const zh = {
  ...
  models: {
    ...
    keyHealthActive: "正常",
    keyHealthCooldown: "冷却中",
    keyHealthEvicted: "已失效 (401)",
    resetKeys: "重置 Key 状态",
    resettingKeys: "重置中…",
    keysResetSuccess: "API key 状态已重置",
  },
...
- candidate_round_limit：\`5\``,
    ...
    openAgents: "智能体面板",
    resumeSubagent: "恢复运行",
    subagentResumed: "子智能体已恢复运行",
    apiTrackerTitle: "API 追踪器",
    workspacePanel: "工作区",
  ...
  apiTracker: {
    ...
    estimatedCost: "预估成本",
    noKeys: "未配置任何 API 密钥",
    noLogs: "暂无 API 错误或调用日志",
    filterPlaceholder: "按模型或提供商过滤...",
  },
};

...
export const en: Strings = {
  ...
  models: {
    ...
    multiKeySingle: "Single key",
    multiKeyRotation: "Multi-key rotation",
    multiKeyPlaceholder:
      "Enter multiple API keys (one per line or comma-separated) for round-robin rotation, 429 backoff, and failover...",
    keyHealthTitle: (healthy: number, total: number): string =>
      `API Key Health (${healthy}/${total} healthy)`,
    keyHealthActive: "Active",
    keyHealthCooldown: "Cooldown",
    keyHealthEvicted: "Evicted (401)",
...
- candidate_round_limit: \`5\``,
  ...
  apiTracker: {
    panelTitle: "API Tracker",
    endpoints: "API Endpoints",
    activeKeys: "Key Health",
    logs: "API Logs",
    usage: "Usage & Cost",
    ...
    resetSuccess: "Key health reset successfully",
    refresh: "Refresh",
    ...
    noLogs: "No API errors or logs recorded",
    filterPlaceholder: "Filter by model or provider...",
  },
};

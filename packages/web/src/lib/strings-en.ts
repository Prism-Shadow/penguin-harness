...
export const en: Strings = {
  ...
  activities: {
    ...
    unassignedScene: "Not used by any scene",
    unassignedSceneHint:
    ...
    reuseTitle: "Reuse a bound asset",
    reuseHint: "Point this asset at a file another asset of the same type already uses.",
    reuseChoose: "Choose a bound asset",
    reuseApply: "Reuse selected asset",
    clearBinding: "Clear media path",
    mediaPathProblems: {
      empty: "Enter a media path, or leave the asset unbound.",
      prefix: "A media path starts with media/ and never names a URL.",
      characters: "Use letters, digits, spaces and _ . - / only.",
      segment: "Remove empty, dot and traversal segments from the path.",
      length: "A media path is at most 1024 characters.",
    },
    noInAppPreview: "This media type has no in-app preview. Assemble the module to review it.",
    ...
    librarySearch: "Search by file name",
    libraryEmpty: "Nothing has been uploaded for this activity yet.",
    libraryNoMatches: "No uploaded file matches this search.",
    libraryLoading: "Loading uploaded media…",
    librarySelected: "Selected file",
    libraryChoosePrompt: "Choose a file to see it here.",
    libraryUse: "Use this file",
    libraryFile: "File",
    librarySize: "Size",
    libraryUploadedAt: "Uploaded",
    ...
    diffPosition: (current: number, total: number) => `${current} / ${total}`,
    diffPrevious: "Previous change",
    diffNext: "Next change",
    diffInline: "Inline",
    diffSideBySide: "Side by side",
    diffToInline: "Switch to the inline view",
    diffToSideBySide: "Switch to the side-by-side view",
    diffRevert: "Revert all changes",
    diffRevertConfirm: "Discard every edit and return to the saved specification?",
    diffScenes: "Scenes",
    diffSceneChange: {
      added: "added",
      removed: "removed",
    ...
    diffFolded: (lines: number) => `${lines} unchanged lines`,
    diffSavedSide: "Saved specification",
    diffEditedSide: "Your edit",
    diffTooLarge:
      "This specification is too long to compare line by line, so every line is shown as replaced.",
    mediaCategories: {
      audio: "Audio",
      image: "Images",
      video: "Video",
    ...
    saveSpec: "Validate and save",
    generate: "Generate specification",
    agent: "Generation agent",
    runs: "Generation history",
    noRuns: "No generation attempts yet.",
    openSession: "Open Session / approvals",
    cancel: "Cancel generation",
    candidate: "View candidate JSON",
    useCandidate: "Copy candidate into editor",
    reload: "Reload draft",
    loading: "Loading…",
    busy: "Working…",
    saved: "Saved",
    ...
    runningHelp:
      "Generation continues when you leave this page. Open its Session to answer tool approvals.",
    ...
    status: {
      ...
      succeeded: "Applied",
      failed: "Failed",
      conflict: "Draft changed — candidate preserved",
      cancelled: "Cancelled",
      interrupted: "Interrupted",
    },
    draftStatus: {
  ...
  codingAgents: {
    title: "Coding agents",
    description:
      "Run external coding agents (Agent Client Protocol) against a folder on the server, and watch their sessions.",
    agentsTitle: "Agents",
    addAgent: "Add agent",
    removeAgent: "Remove",
    removeConfirmTitle: "Remove agent",
    ...
    commandHint: "Program on the server machine, found on PATH or given as an absolute path.",
    argsLabel: "Arguments",
    ...
    stop: "Stop",
    modeLabel: "Mode",
    permissionTitle: "The agent asks for permission",
    allow: "Allow",
    reject: "Reject",
    noticeTitle: "The agent requested input",
    toolOutput: "Output",
    toolInput: "Input",
    thinking: "Thinking",

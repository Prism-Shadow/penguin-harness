...
export const KEY_RULES: readonly KeyRule[] = [
  ...
  },
  {
    ...
    scope: "install",
    why: "The Sessions each machine was last seen holding, shown until its forward is back up. Project id and machine id in the key, Session ids in the value — a new root knows none of them.",
  },
  {
    kind: "family",
    key: "penguin.machineAgents.",
    scope: "install",
    why: "The Agents each machine was last seen running, offered by the composer until its forward is back up. Keyed by the same Project and machine a new root would not have.",
  },
  {
    kind: "family",

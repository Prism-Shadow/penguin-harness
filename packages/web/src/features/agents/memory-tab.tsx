      ...
      <div className="flex items-start justify-between gap-4 rounded-lg border border-gray-200 px-4 py-3 dark:border-gray-800">
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
            {enabled ? S.memory.enabledHint : S.memory.disabledHint}
          </p>
          {memoryDir && (
            <p className="mt-1.5 break-all font-mono text-[11px] text-gray-400 dark:text-gray-500">
              {memoryDir}
            </p>
          )}
        </div>

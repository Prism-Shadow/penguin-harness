 ...
 * pricing removes local pricing. Locally added models (including user-defined groups) are kept
 * untouched. Credentials are never touched: merged rows carry no apiKey input (the

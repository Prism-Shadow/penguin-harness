 ...
 * non-field lines such as the explanation sentence are ignored. The old
 * `<model_switch_from>` form is still recognized: traces produced while the switch command
 * shipped with the angle form are re-rendered through this parser.
 */

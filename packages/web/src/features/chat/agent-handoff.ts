 ...
 * `[scheduled_task]`, `[feishu_message]`, `[model_switch_from]` — are defined in core's
 * marker module (`@prismshadow/penguin-core/markers`) alongside every other message
 * marker, and are re-exported below under this feature's existing names.
 */

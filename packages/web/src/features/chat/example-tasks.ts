 ...
 *
 * Keep the folders within a row of each other's length: the draft page reserves no scroll area
 ...
 * the selected Agent has them installed; an empty list fills the prompt alone.
 */

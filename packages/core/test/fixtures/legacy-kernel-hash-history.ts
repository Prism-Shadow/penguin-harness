/**
 * The frozen pre-refactor `KERNEL_HASH_HISTORY`: the generation-keyed snapshot the kernel
 * record replaced (`{ kernelVersion: { leafPath: sha256 } }`, oldest first, every leaf of
 * every generation). Six generations, 158 entries, 37 of them distinct `(leaf, hash)` pairs.
 *
 * It ships nowhere — it exists so `kernel-version.test.ts` can prove the flat record in
 * `kernel-history.ts` reaches the same advance/keep decision for every `(leaf, hash)` pair
 * the old table could ever have matched, and keeps reaching it as later kernels are appended
 * (a bump that changes a default without recording the superseded hash fails that proof).
 *
 * Frozen: never edit, never extend. New generations are recorded in `kernel-history.ts`.
 */
export const LEGACY_KERNEL_HASH_HISTORY: Readonly<
...
> = {
  ...
  "2026-08-18": {
    ...
    "tools.builtin.input_command":
      "4c907500cda145161a9481803cfb57ed814b6793e762fd6284510187e9d781c8",
    "tools.builtin.run_subagent":
      "be00af47c7098cde840a662c99f9f6d0cdf8358883e09974ce840b0c4683a9af",
    "tools.builtin.input_subagent":
      "22cc4648d773e8422e80a12a7a095b00b7f7eb01ab5a9ea080858dcd7517b4e3",
    "tools.builtin.read_image": "05b797a88df1e6a90fb3da67ec654b206f8d81291f89d160a505620afcea38bb",
    "tools.builtin.describe_image":
  ...
  "2026-08-19": {
    ...
    "tools.builtin.input_command":
      "4c907500cda145161a9481803cfb57ed814b6793e762fd6284510187e9d781c8",
    "tools.builtin.run_subagent":
      "f43ac4f9621032d554275be1d416f994f0d3cc0918537de99c974e436eb69316",
    "tools.builtin.input_subagent":
      "22cc4648d773e8422e80a12a7a095b00b7f7eb01ab5a9ea080858dcd7517b4e3",
    "tools.builtin.read_image": "05b797a88df1e6a90fb3da67ec654b206f8d81291f89d160a505620afcea38bb",
    "tools.builtin.describe_image":

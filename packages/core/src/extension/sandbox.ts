/**
 * The sandbox vocabulary an extension compiles against — types only.
 *
 * It lives in core, alongside the rest of the extension contract, because a backend is
 ...
 * and live in the server package, so an extension carries no runtime dependency on core.
 */

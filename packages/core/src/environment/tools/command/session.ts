...
export class ManagedSession {
  ...
  /**
   * Whether a stop was asked of this session (`kill`/`killHard`). The exit that follows is a
   * deliberate stop — a capacity eviction, an idle reap, the host's stop button — never a

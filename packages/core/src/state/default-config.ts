...
- Search from \`CWD\` down — never \`find /\`, never walk the user's home or the whole filesystem. When a path does not resolve, narrow by reasoning about the project's layout instead of widening the search root.

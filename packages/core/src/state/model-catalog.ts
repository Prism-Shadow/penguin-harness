 ...
 * flash-vision-exp): 2026-09-08, for the official adjustment effective 2026-09-10; the GPT-6
 * Astra rows (direct + OpenRouter): 2026-09-09; the pre-registered deepseek-v4.1-flash row:
 * 2026-09-09, from DeepSeek's release announcement — per each provider's docs).

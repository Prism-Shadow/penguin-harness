...
export class Agent {
   ...
   * opens (buildRuntime's openContext) and a resume that finds its context closed — so an
  ...
  private buildRuntime(
    ...
    // openContext). The toolset is resolved lazily by the bootstrap below (Session's first

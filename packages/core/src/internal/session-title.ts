 ...
 * handoff / scheduled task / model switch prepend their own blocks) — meaningful to the
 * runtime, noise in a title. The list is a fixed allowlist so ordinary bracketed text is
 * left untouched.
 */

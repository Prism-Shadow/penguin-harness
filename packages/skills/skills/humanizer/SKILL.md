...
The full tell catalog is in [`reference/tells.md`](reference/tells.md), per-language surface forms in the `reference/languages/` files indexed by [`reference/language-cues.md`](reference/language-cues.md), and the measured record behind all of it in [`reference/case-study.md`](reference/case-study.md).

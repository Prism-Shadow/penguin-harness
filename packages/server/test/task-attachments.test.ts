 ...
 *   - malformed parts are 400s, too many files in one message is a 413, and goal mode rejects
 *     attachments before anything is written (there is no size limit to test: a file's bytes
 *     go to disk and come back through the model's own file tools);

 ...
 *
 * One place, because the same write lands wherever a credential hits disk — today the CLI's
 * saved session — and the hole it closes was found separately in two such writers before this
 * was shared. Someone who can write the directory but not read the file could park a symlink at
 * the

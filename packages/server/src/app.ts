...
import { pluginRegistryRoutes } from "./http/routes/plugins.js";
 ...
 * falls back to an empty host (see hmr/plugin.ts's pluginHostFrom).
 */
export async function bootAppDeps(
  ...
  if (plugins !== undefined) hmr.resources.register(PLUGINS_RESOURCE_ID, plugins);
...
export function createApp(
  ...
  app.route("/api/plugins", pluginRegistryRoutes());

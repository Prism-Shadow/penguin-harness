...
export interface SessionInfo {
  ...
  modelId: string;
  workspace: string;
  /** Current system-wide approval mode, repeated on Session rows for client compatibility. */
  approvalMode: ApprovalMode;
...
export interface SessionPatchRequest {
  /** Backward-compatible entry point: changes the system-wide mode, not only this Session. */
  approvalMode?: ApprovalMode;
...
export type ServerEvent =
  ...
  /** The system-wide approval mode changed; every open composer updates immediately. */

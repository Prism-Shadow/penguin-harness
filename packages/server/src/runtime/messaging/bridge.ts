...
// Fixed outbound notices use the shipped English copy.
 ...
 * timeout. The reason is machine text in parentheses after the notice, so the
 * sentence stays readable whatever the channel says.
 *

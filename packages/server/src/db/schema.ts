 ...
 * Agent & Session indexes / usage summaries / error records / user settings / UI preferences. Agent State,
...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  approval_mode TEXT NOT NULL DEFAULT 'allow-all',   -- legacy API snapshot; runtime authority is user_settings
...
CREATE TABLE IF NOT EXISTS user_settings (
  ...
  approval_mode TEXT NOT NULL DEFAULT 'allow-all'
                      CHECK (approval_mode IN ('allow-all', 'deny-all', 'read-only', 'always-ask'))
);
`;

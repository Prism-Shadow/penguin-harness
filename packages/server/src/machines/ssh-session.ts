...
/**
 * The shells, by machine address. Held for the process rather than per App: the ssh children
 * outlive a hot swap exactly as the tunnels do, and reopening every connection on each push
 * would reintroduce the cost this exists to remove.
 */

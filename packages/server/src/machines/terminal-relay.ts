 ...
 * machine's own stream through the connection this server holds to it (a channel dialled
 * through the session's SOCKS port, like every other request to a machine's API). Platform
 * code, pushed like any other; the runtime is exactly what it was.
 *

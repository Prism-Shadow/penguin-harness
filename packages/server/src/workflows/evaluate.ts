/**
 * A stored workflow script, evaluated into the plugin seam's own currency.
 *
 ...
 * wraps as a {@link WorkflowFactory} (see ../hmr/plugin.ts). Installed workflows and
 * plugin-registered ones therefore enter the harness through exactly one door — the
...
import type { WorkflowFactory, WorkflowInstance } from "../hmr/plugin.js";

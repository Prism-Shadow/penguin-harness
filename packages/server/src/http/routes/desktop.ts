 ...
 * /api/desktop/update, the tray-icon preference at /api/desktop/tray, the shell's native
 * actions under /api/desktop/shell, plus the shared desktop-mode guard that turns off

...
Open the Settings dialog (the user menu, admin only) and its **Plugins** page. The bot is listed there with the settings group its module declares, and nothing else configures it — no environment variable, no file to edit:

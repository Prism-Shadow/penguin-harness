...
import { CONFIG_GROUP, botConfigOf } from "./config.js";
...
export class DiscordBots {
  ...
  async start(): Promise<void> {
    this.unwatch = this.deps.pluginConfig.watch(CONFIG_GROUP, () => void this.reconcile());
  ...
  private async runPass(): Promise<void> {
    ...
    const config = botConfigOf(this.deps.pluginConfig.get(CONFIG_GROUP), this.deps.agents);

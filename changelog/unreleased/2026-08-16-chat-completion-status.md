...
- **Finished, unread** — a small green dot. It is a notification rather than a status: it says there is a reply here you have not seen. It uses the emerald the Session status dot has always used, one tone in both themes.

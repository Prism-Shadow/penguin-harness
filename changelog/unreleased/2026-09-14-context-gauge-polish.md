...
- The value that floats under the compaction cutter while it is dragged (or arrowed) now uses the panel's own text size, bold, instead of a ten-pixel chip that was hard to read mid-gesture.

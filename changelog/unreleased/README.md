...
- [2026-08-13] Core + Web App: MCP tools gain an opt-in on-demand mode with a fixed search/execution gateway, versioned references, local Schema validation, stable prompt-cache prefixes, and the original approval and execution controls; direct exposure remains the compatible default. ([details](2026-08-13-lazy-mcp-tool-exposure.md))

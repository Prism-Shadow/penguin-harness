...
- [2026-08-16] Web: session states are told apart by icon shape — a pulsing hourglass while running, a transient green circled check once a run completes (until acknowledged), inward chevrons while compacting. ([details](2026-08-16-chat-completion-status.md))

...
- [2026-08-16] Web: running Sessions use a neutral spinner, while newly completed Sessions keep a transient green completion marker until acknowledged. ([details](2026-08-16-chat-completion-status.md))

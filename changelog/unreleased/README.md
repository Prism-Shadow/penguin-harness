...
- [2026-08-03] Server/Web: file attachments, including file-only messages, can steer a running Task and use the Session scratchpad safely. ([details](2026-08-03-steering-file-attachments.md))

...
- [2026-08-16] Queued steering and follow-up messages can be recalled back into the composer for editing and resending (#287). ([details](2026-08-16-recall-queued-messages.md))

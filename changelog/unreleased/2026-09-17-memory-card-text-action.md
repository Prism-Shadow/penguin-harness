# The memory-change card opens the memory list with a text action instead of a second brain icon
...
hint: small gray text that darkens on hover, with no background. The card keeps one brain icon.

...
- Reworked the taller hero around the PenguinHarness name and concise open-source, local-first positioning, with single-line bilingual copy, paired desktop-download and command-line-install buttons, a visible release version, larger unframed product proof points, and a complete supported-model-family strip.

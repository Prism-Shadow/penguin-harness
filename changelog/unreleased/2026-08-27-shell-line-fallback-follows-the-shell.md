...
- The design spec's byte-identity guarantee was restated in the same terms, reading off the resolved shell rather than the platform ([penguin-harness-design #69](https://github.com/Prism-Shadow/penguin-harness-design/pull/69)).

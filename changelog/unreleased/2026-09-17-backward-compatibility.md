...
[中文版](2026-09-17-backward-compatibility.zh.md)

Sessions created before this change have no sandbox policy of their own. Migration 11, `sessions-sandbox`, adds a nullable `sandbox` column to the `sessions` table, and existing rows start with it empty.

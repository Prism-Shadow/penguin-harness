...
- An interrupted run's carried harness injection is replaced with a one-line stale note at the carry-over consumer sites (the goal-specific downgrade generalized); completion notices pass through — they are reports, not instructions.

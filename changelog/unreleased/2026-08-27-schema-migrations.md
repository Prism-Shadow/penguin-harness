...
- The first migration is 0.2.4 → 0.2.7: the `messaging_bindings` table and three indexes, all additive. A 0.2.4 database that has run it holds exactly the schema a current build creates from scratch.

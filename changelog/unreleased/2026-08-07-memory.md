...
- **Workspace scope** (`memory/<workspace_key>/`) — facts about one Workspace: project decisions, feedback received, pointers into its external systems. Sessions of one agent in one Workspace share it; different Workspaces keep their topic files apart.

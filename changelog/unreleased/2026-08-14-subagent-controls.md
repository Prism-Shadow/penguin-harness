...
The Server adds parent-owned child control endpoints under `/api/sessions/:parentId/subagents`; unknown and inaccessible children retain the Session API's non-leaking 404 behavior.

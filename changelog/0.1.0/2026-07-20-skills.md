...
[中文版](2026-07-20-skills.zh.md)

## One-shot RAG app flow: skills rewrite and a draft-screen example task

The [#11](https://github.com/Prism-Shadow/penguin-harness/pull/11) squash — briefly lost to a force-push race during the branch rebase — is restored: the skills library rewrite that makes one-sentence RAG apps one-shot, a draft-screen example task card, and the finished-product showcase pipeline.

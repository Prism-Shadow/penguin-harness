...
one-line-per-change index, and detail files live inside the folder (mirrors agenthub
[#162](https://github.com/Prism-Shadow/agenthub/pull/162)).
...
@prismshadow/agenthub 0.3.3 -> 0.4.0 (agenthub
[#159](https://github.com/Prism-Shadow/agenthub/pull/159)): content items replace the item-level

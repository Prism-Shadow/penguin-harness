...
## Tool-card subtitles render once, fully formed ([#137](https://github.com/Prism-Shadow/penguin-harness/issues/137))
...
## Session list: DB-served by default, CLI sessions opt-in, groups page ([#139](https://github.com/Prism-Shadow/penguin-harness/issues/139))

...
- [2026-07-22] The default system prompt gains two guardrails — protect the harness's own services and ports, and stop after one retry on API auth/key errors — with the default ports now a core SDK constant. ([details](2026-07-22-agent-guardrails.md))
...
- [2026-07-22] Sites: the docs and landing navbars are now identical, the blog gains a Tech-practice category, pinned posts and author/date/copy-link metadata, and the built-in Skills are listed in the READMEs and on the landing page. ([details](2026-07-22-sites-and-blog.md))

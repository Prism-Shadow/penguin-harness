...
- [2026-07-22] Sites: the docs and landing navbars are now identical, the blog gains a Tech-practice category, pinned posts, author/date/copy-link metadata, a second AMD practice post and three bilingual technical posts (harness minimalism against the Databricks benchmark, a sourced comparison of five agent frameworks, and the shift from human-facing to agent-facing infrastructure), and the built-in Skills are listed in the READMEs and on the landing page. ([details](2026-07-22-sites-and-blog.md))

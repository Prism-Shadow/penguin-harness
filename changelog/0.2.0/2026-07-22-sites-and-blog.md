...
- **AI Infrastructure: Past, Present, and Future** — traces the shift from human-facing to agent-facing infrastructure across documentation, protocols, tool interfaces and error messages, including llms.txt's 97% zero-fetch rate against the success of plain Markdown, content negotiation and AGENTS.md, and the independent convergence of Anthropic, Cloudflare and the MCP spec on code-and-filesystem as the tool interface.
